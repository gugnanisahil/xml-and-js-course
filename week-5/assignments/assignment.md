...
- Add js code that adds table rows from this array
...
- create html form that would alloww you to filter table result by first name, last name, email, gender, or ip address
- add reset filters button that would reset url params, form values and table rows
